...
function Countdown() {
  ...
  return (
    <section className="inv6-countdown" aria-labelledby="inv6-countdown-title">
      <div className="inv6-content" data-inv6-reveal>
        <p id="inv6-countdown-title">Do našeg dana ostalo je</p>
        {timeLeft.finished ? (
          <h2>Danas je naš dan</h2>
        ) : (
          <div className="inv6-countdown__grid" role="timer" aria-live="off">
            {units.map(([value, label]) => (
              <div className="inv6-countdown__unit" key={label}>
