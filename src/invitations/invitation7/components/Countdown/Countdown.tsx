...
function Countdown() {
  ...
  return (
    <section className="inv7-countdown" aria-labelledby="inv7-countdown-title">
      <div className="inv7-content" data-inv7-reveal>
        <p id="inv7-countdown-title">Do našeg dana ostalo je</p>
        {timeLeft.finished ? (
          <h2>Danas je naš dan</h2>
        ) : (
          <div className="inv7-countdown__grid" role="timer" aria-live="off">
            {units.map(([value, label]) => (
              <div className="inv7-countdown__unit" key={label}>
