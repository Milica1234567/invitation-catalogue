...
function Countdown() {
  ...
  return (
    <section className="inv5-countdown" aria-labelledby="inv5-countdown-title">
      <div className="inv5-countdown__petal" aria-hidden="true" />
      <div className="inv5-content" data-inv5-reveal>
        <p id="inv5-countdown-title">Do našeg dana ostalo je</p>
        {timeLeft.finished ? (
          <h2>Danas je naš dan</h2>
        ) : (
          <div className="inv5-countdown__grid" role="timer" aria-live="off">
            {units.map(([value, label]) => (
              <div className="inv5-countdown__unit" key={label}>
